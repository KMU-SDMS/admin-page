...
export function InquiryKanbanBoard({ inquiries, isLoading, onStatusChange }: InquiryKanbanBoardProps) {
  ...
  const handleStatusAdvance = async (inquiry: InquiryWithStudent) => {
    const nextStatus = getNextStatus(inquiry.status as keyof typeof statusConfig)
    if (nextStatus) {
                        ...
                        <CardContent className="p-4">
                          <div className="space-y-3">
                            <div className="flex items-start justify-between gap-2">
                              <h4 className="font-medium line-clamp-2 text-sm">{inquiry.title}</h4>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              {getNextStatus(inquiry.status as keyof typeof statusConfig) && (
                                <Button
                                  size="sm"
                                  variant="ghost"
