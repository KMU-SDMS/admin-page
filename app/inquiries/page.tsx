...
export default function InquiriesPage() {
  ...
  const categories = Array.from(new Set(inquiries.map((i) => i.category))).sort()
  ...
  const handleStatusChange = async (inquiryId: number, newStatus: "OPEN" | "IN_PROGRESS" | "RESOLVED") => {
    try {
  ...
  const stats = {
    ...
    inProgress: enrichedInquiries.filter((i) => i.status === "IN_PROGRESS").length,
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">학생 문의사항 접수 및 처리 현황 관리</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold mt-2 text-blue-600">{stats.open}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold mt-2 text-orange-600">{stats.inProgress}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6">
              ...
              <div className="text-2xl font-bold mt-2 text-green-600">{stats.resolved}</div>
            </CardContent>
          </Card>
        </div>
